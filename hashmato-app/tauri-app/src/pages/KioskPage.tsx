  ...
  <div className="p-4 sm:p-6">
    {!orderPlaced ? (
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
        {/* Menu Grid */}
        <div className="md:col-span-2 lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
          {menu.map((m) => (
        ...
        {/* Cart */}
        <div className="bg-white rounded-xl shadow-lg p-4 flex flex-col md:col-span-1">
          <h3 className="font-bold text-base sm:text-lg border-b pb-2 mb-3">
            Your Cart
          </h3>
          ...
          {cart.length > 0 && (
            <div className="mt-4">
              ...
              <button
                onClick={placeOrder}
                className="w-full mt-3 bg-blue-600 text-white py-2.5 sm:py-3 rounded-lg text-base sm:text-lg font-medium hover:bg-blue-700 transition"
              >
                Place Order
              </button>
            </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[60vh] sm:min-h-[70vh] text-center px-4">
        ...
        <div className="mt-6 bg-white shadow-xl rounded-xl sm:rounded-2xl p-6 sm:p-8 w-full max-w-sm sm:max-w-md">
        ...
        <button
          ...
          className="mt-6 sm:mt-8 px-5 sm:px-6 py-2.5 sm:py-3 bg-slate-800 text-white rounded-lg hover:bg-slate-900 text-sm sm:text-base"
        >
          Back to Menu
        </button>
      </div>
